...
PARSER.add_argument(
    "--data_dir", type=str, default="/data", help="Location for the dataset."
)
PARSER.add_argument(
    "--config_name",
    type=str,
...
PARSER.add_argument(
    "--predictions_path",
    type=str,
    default="/results/predictions.smi",
...
PARSER.add_argument(
    ...
    type=int,
    default=20,
    help="Frequency for writing logs, expressed in steps.",
)
PARSER.add_argument(
    "--warmup_steps",
    type=int,
...
PARSER.add_argument(
    "--learning_rate", type=float, default=0.0005, help="Base learning rate."
)
PARSER.add_argument(
    "--beta1", type=float, default=0.9, help="beta1 parameter for the optimizer."
)
PARSER.add_argument(
    "--beta2", type=float, default=0.99, help="beta2 parameter for the optimizer."
)
...
PARSER.add_argument(
    "--num_workers", type=int, default=4, help="Number of workers in the data loader."
)
PARSER.add_argument(
    "--seed",
    type=int,
    default=1,
    help="Random seed used to initialize the distributed loaders.",
)
PARSER.add_argument(
    "--local_rank",
...
PARSER.add_argument(
    "--temperature", type=float, default=0.3, help="Temperature used for sampling."
)
PARSER.add_argument(
    "--val_batch_size",
    type=int,
    default=100,
    help="Number of molecules to generate during validation step.",
)
PARSER.add_argument(
    "--allow_untrained",
    action="store_true",
...
PARSER.add_argument(
    "--correct_validity",
    action="store_true",
    help="Apply validity correction after the generation of the molecules.",
)
PARSER.add_argument("--amp", action="store_true", help="Use Automatic Mixed Precision.")
PARSER.add_argument(
    "--cuda_graph",
    action="store_true",
    help="Capture GPU kernels with CUDA graphs. This option allows to speed up training.",
)
PARSER.add_argument(
    "--jit",
    action="store_true",
    help="Compile the model with `torch.jit.script`. Can be used to speed up training or inference.",
)
PARSER.add_argument(
    "--verbosity",
    type=int,
    default=1,
    choices=list(LOGGING_LEVELS),
