...
from . import (FairseqIncrementalDecoder, register_model,
    ...
    def build_model(cls, args):
        ...
        if args.share_all_embeddings:
            ...
            encoder_embed_tokens = Embedding(
                args.src_vocab_size, args.encoder_embed_dim, args.padding_idx
            )
            ...
            decoder_embed_tokens = Embedding(
                args.tgt_vocab_size, args.decoder_embed_dim, args.padding_idx
            )
