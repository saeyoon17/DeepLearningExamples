...
def main():
    ...
    parser.add_argument(
        "--mosesdecoder_dir", help="path to mosesdecoder root directory"
    )
    parser.add_argument(
        "--sym_heuristic",
    ...
    parser.add_argument(
        "--source_file", help="path to a file with sentences " "in the source language"
    )
    parser.add_argument(
        "--target_file", help="path to a file with sentences " "in the target language"
    )
