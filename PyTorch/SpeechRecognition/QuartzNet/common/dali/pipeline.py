...
def make_dali_asr_pipeline(
    ...
    do_spectrogram_masking = (
        mask_time_num_regions > 0
        or mask_freq_num_regions > 0
        or mask_both_num_regions > 0
    )
    ...
    assert (
        preprocessing_device == "cpu" or preprocessing_device == "gpu"
