...
def parse_args():
    ...
    optim.add_argument("--batch_size", default=32, type=int, help="Global batch size")
...
def main():
    ...
    checkpointer = Checkpointer(args.output_dir, "Jasper", args.keep_milestones)
    if args.resume:
