...
from utils.file_utils import (DUMMY_INPUTS, TF2_WEIGHTS_NAME, TF_WEIGHTS_NAME,
                              WEIGHTS_NAME, ModelOutput, cached_path,
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        if state_dict is None and not from_tf:
            try:
                ...
                if (
                    "state_dict" in state_dict.keys()
                ):  # Loading models that store optimizer states, etc along with state_dict in ckpt
