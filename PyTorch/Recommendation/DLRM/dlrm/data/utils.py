...
import torch
import tqdm
from dlrm.data.defaults import DTYPE_SELECTOR, TEST_MAPPING, TRAIN_MAPPING
...
def collate_array(
    ...
    categorical_features = categorical_features.to(device, non_blocking=True).to(
        torch.long
    )
