...
import numpy as np
import yaml
from dlrm.data.defaults import (CARDINALITY_SELECTOR, CATEGORICAL_CHANNEL,
                                DTYPE_SELECTOR, FEATURES_SELECTOR,
                                FILES_SELECTOR, LABEL_CHANNEL,
                                NUMERICAL_CHANNEL, SPLIT_BINARY, TEST_MAPPING,
                                TRAIN_MAPPING, TYPE_SELECTOR,
