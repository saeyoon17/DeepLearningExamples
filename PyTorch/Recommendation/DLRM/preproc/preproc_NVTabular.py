...
TEST_DS_MEM_FRAC = 0.045
VALID_DS_MEM_FRAC = 0.045
...
def preprocess_criteo_parquet(
    ...
    cont_features = CRITEO_CONTINUOUS_COLUMNS >> ops.FillMissing(fill_val=-2.0) >> LambdaOp(lambda col, _: col.add(2.0)) >> LogOp()
