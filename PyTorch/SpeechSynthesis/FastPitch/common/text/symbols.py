...
def get_symbols(symbol_set="english_basic"):
    if symbol_set == "english_basic":
        ...
        from .zh.chinese import chinese_punctuations
        from .zh.chinese import valid_symbols as mandarin_valid_symbols
        ...
        _letters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"
        symbols = (
            list(_pad + _special + _punctuation + _letters)
            + _arpabet
            + _mandarin_phonemes
