...
from common.utils import get_padding, init_weights, print_once
from torch.nn import (AvgPool1d, AvgPool2d, Conv1d, Conv2d, ConvTranspose1d,
                      ConvTranspose2d)
...
class Generator(torch.nn.Module):
    def __init__(self, h):
        ...
        self.conv_pre = weight_norm(
            Conv2d(80, h.upsample_initial_channel, (7, 1), (1, 1), padding=(3, 0))
        )
...
class DiscriminatorPConv1d(torch.nn.Module):
    def __init__(self, period, kernel_size=5, stride=3, use_spectral_norm=False):
        ...
        self.conv_post = norm_f(
            Conv2d(1024, 1, (3, 1), 1, padding=(1, 0), dilation=(period, 1))
        )
            ...
            [
                ...
                norm_f(
                    Conv2d(
                        ...
                        (41, 1),
                        (2, 1),
                        groups=1 if amp_groups else 16,
                        padding=(20, 0),
                    )
                ),  # was: groups=16
                norm_f(
