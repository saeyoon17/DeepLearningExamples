...
def parse_args():
    ...
    parser.add_argument(
        "--length", type=int, required=True, help="Length of the generated input data"
    )
...
def main():
    ...
    dataloader = dm.get_dataloader_fn(
        dataset_path=args.dataset_path, batch_size=1, precision=args.precision
    )
