...
def parse_args(parser):
    ...
    transf.add_argument(
        "--fade-out", type=int, default=6, help="Number of fadeout frames at the end"
    )
    transf.add_argument(
    ...
    txt.add_argument(
        "--heteronyms-path", type=str, default="data/cmudict/heteronyms", help=""
    )
    txt.add_argument(
        "--cmudict-path", type=str, default="data/cmudict/cmudict-0.7b", help=""
    )
    return parser
