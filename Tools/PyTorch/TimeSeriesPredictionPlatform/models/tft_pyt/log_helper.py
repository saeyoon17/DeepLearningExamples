...
def setup_logger(args):
    ...
    dllogger.metadata(
        "items/s", {"GOAL": "MAXIMIZE", "STAGE": "TRAIN", "format": ":1f"}
    )
    ...
    dllogger.metadata(
        "val_items/s", {"GOAL": "MAXIMIZE", "STAGE": "VAL", "format": ":1f"}
    )
    dllogger.metadata(
        "test_P10", {"GOAL": "MINIMIZE", "STAGE": "TEST", "format": ":5f"}
    )
    dllogger.metadata(
        "test_P50", {"GOAL": "MINIMIZE", "STAGE": "TEST", "format": ":5f"}
    )
    dllogger.metadata(
        "test_P90", {"GOAL": "MINIMIZE", "STAGE": "TEST", "format": ":5f"}
    )
    dllogger.metadata(
        "throughput", {"GOAL": "MAXIMIZE", "STAGE": "TEST", "format": ":1f"}
    )
    dllogger.metadata(
        "latency_p90", {"GOAL": "MIMIMIZE", "STAGE": "TEST", "format": ":5f"}
    )
    dllogger.metadata(
        "latency_p95", {"GOAL": "MIMIMIZE", "STAGE": "TEST", "format": ":5f"}
    )
    dllogger.metadata(
        "latency_p99", {"GOAL": "MIMIMIZE", "STAGE": "TEST", "format": ":5f"}
    )
