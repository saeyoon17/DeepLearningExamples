...
def _get_full_path_of_ckpt(args):
    ...
    if args.last_epoch_of_checkpoint is None:
        ...
        target_from_checkpoint = os.path.join(args.from_checkpoint, epoch_with_prefix)
    else:
        try:
...
def add_global_args(parser):
    ...
    group.add_argument(
        "--epochs", type=int, default=90, help="The number of epochs for training."
    )
    group.add_argument(
        "--save-interval",
        type=int,
...
def add_advance_args(parser):
    ...
    # ASP
    group.add_argument(
        "--asp", action="store_true", help="Enable automatic sparse training (ASP)."
    )
    group.add_argument(
        "--prune-model",
        action="store_true",
...
def add_dataset_args(parser):
    ...
    augmentation_group.add_argument(
        "--crop-size", type=int, default=224, help="The size to crop input images."
    )
    augmentation_group.add_argument(
        "--rand-crop-scale",
        type=float_list,
...
def add_model_args(parser):
    ...
    group.add_argument(
        "--num-of-class", type=int, default=1000, help="The number classes of images."
    )
    group.add_argument(
        "--bn-weight-decay",
        action="store_true",
...
def add_training_args(parser):
    ...
    group.add_argument(
        "--momentum", type=float, default=0.875, help="The momentum value of optimizer."
    )
    group.add_argument(
        "--weight-decay",
        type=float,
