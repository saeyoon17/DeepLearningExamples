...
from object_detection.predictors import (convolutional_box_predictor,
                                         ...
                                         rfcn_box_predictor)
from object_detection.predictors.heads import (box_head, class_head,
                                               keras_box_head,
                                               keras_class_head, mask_head)
...
def build_keras(
    ...
    if box_predictor_oneof == "convolutional_box_predictor":
        config_box_predictor = box_predictor_config.convolutional_box_predictor
        conv_hyperparams = conv_hyperparams_fn(config_box_predictor.conv_hyperparams)
