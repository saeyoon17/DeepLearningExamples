...
from object_detection.builders import (anchor_generator_builder,
                                       ...
                                       hyperparams_builder,
                                       image_resizer_builder, losses_builder,
                                       matcher_builder,
                                       post_processing_builder)
from object_detection.builders import \
    region_similarity_calculator_builder as sim_calc
from object_detection.core import balanced_positive_negative_sampler as sampler
from object_detection.core import post_processing, target_assigner
...
def build(model_config, is_training, add_summaries=True):
    ...
    if meta_architecture == "faster_rcnn":
        return _build_faster_rcnn_model(
            model_config.faster_rcnn, is_training, add_summaries
        )
...
def _build_faster_rcnn_model(frcnn_config, is_training, add_summaries):
    ...
    if isinstance(second_stage_box_predictor, rfcn_box_predictor.RfcnBoxPredictor):
