...
from object_detection.builders import (dataset_builder, image_resizer_builder,
                                       model_builder, preprocessor_builder)
from object_detection.core import preprocessor
from object_detection.core import standard_fields as fields
from object_detection.data_decoders import tf_example_decoder
from object_detection.protos import (eval_pb2, input_reader_pb2, model_pb2,
                                     train_pb2)
...
def transform_input_data(
    ...
    if fields.InputDataFields.groundtruth_boxes in tensor_dict:
        tensor_dict = util_ops.filter_groundtruth_with_nan_box_coordinates(tensor_dict)
    ...
    if fields.InputDataFields.groundtruth_instance_masks in tensor_dict:
        ...
        tensor_dict[fields.InputDataFields.groundtruth_instance_masks] = resized_masks

    # Transform groundtruth classes to one hot encodings.
    label_offset = 1
    zero_indexed_groundtruth_classes = (
        tensor_dict[fields.InputDataFields.groundtruth_classes] - label_offset
    )
    ...
    if fields.InputDataFields.groundtruth_confidences in tensor_dict:
        ...
        tensor_dict[fields.InputDataFields.groundtruth_confidences] = tensor_dict[
    ...
    if merge_multiple_boxes:
        ...
        tensor_dict[fields.InputDataFields.groundtruth_confidences] = merged_confidences
    if fields.InputDataFields.groundtruth_boxes in tensor_dict:
...
def pad_input_data_to_static_shapes(
    tensor_dict, max_num_boxes, num_classes, spatial_image_shape=None
):
    ...
    if fields.InputDataFields.image_additional_channels in tensor_dict:
        num_additional_channels = (
            tensor_dict[fields.InputDataFields.image_additional_channels].shape[2].value
        )
    num_image_channels = 3
    if fields.InputDataFields.image in tensor_dict:
        num_image_channels = tensor_dict[fields.InputDataFields.image].shape[2].value
    padding_shapes = {
        # Additional channels are merged before batching.
        fields.InputDataFields.image: [
            height,
            width,
            num_image_channels + num_additional_channels,
        ],
        ...
        fields.InputDataFields.groundtruth_confidences: [max_num_boxes, num_classes],
        ...
        fields.InputDataFields.multiclass_scores: [
            max_num_boxes,
            num_classes + 1 if num_classes is not None else None,
        ],
    ...
    if fields.InputDataFields.num_groundtruth_boxes in padded_tensor_dict:
        padded_tensor_dict[fields.InputDataFields.num_groundtruth_boxes] = tf.minimum(
