...
from object_detection import export_tflite_ssd_graph_lib, exporter
from object_detection.builders import graph_rewriter_builder, model_builder
from object_detection.core import model
from object_detection.protos import (graph_rewriter_pb2, pipeline_pb2,
                                     post_processing_pb2)
...
class ExportTfliteGraphTest(tf.test.TestCase):
    ...
    def _export_graph_with_postprocessing_op(self, pipeline_config, num_channels=3):
