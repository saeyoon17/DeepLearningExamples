...
from object_detection.core import (box_list, box_list_ops, box_predictor,
                                   losses, model)
...
class FasterRCNNMetaArch(model.DetectionModel):
    ...
    def _add_detection_features_output_node(
        self, detection_boxes, rpn_features_to_crop
    ):
        ...
        detection_features = tf.identity(detection_features, "detection_features")
    ...
    def _loss_box_classifier(
        ...
        with tf.name_scope("BoxClassifierLoss"):
            ...
            if prediction_masks is not None:
                ...
                mask_losses_weights = batch_mask_target_weights * tf.to_float(
                    paddings_indicator
                )
