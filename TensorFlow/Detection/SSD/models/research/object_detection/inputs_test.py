...
from object_detection.utils import config_util, test_case
...
class DataAugmentationFnTest(test_case.TestCase):
    def test_apply_image_and_box_augmentation(self):
        ...
        self.assertAllEqual(
            augmented_tensor_dict_out[fields.InputDataFields.image].shape, [20, 20, 3]
        )
        self.assertAllClose(
    ...
    def test_apply_image_and_box_augmentation_with_scores(self):
        ...
        self.assertAllClose(
            augmented_tensor_dict_out[fields.InputDataFields.groundtruth_classes], [1.0]
        )
        self.assertAllClose(
            augmented_tensor_dict_out[fields.InputDataFields.groundtruth_weights], [0.8]
        )
...
class DataTransformationFnTest(test_case.TestCase):
    def test_combine_additional_channels_if_present(self):
        ...
        tensor_dict = {
            fields.InputDataFields.image: tf.constant(image),
            fields.InputDataFields.image_additional_channels: tf.constant(
                additional_channels
            ),
            fields.InputDataFields.groundtruth_classes: tf.constant(
        ...
        self.assertAllEqual(
            transformed_inputs[fields.InputDataFields.image].dtype, tf.float32
        )
        self.assertAllEqual(
            transformed_inputs[fields.InputDataFields.image].shape, [4, 4, 5]
        )
        self.assertAllClose(
    ...
    def test_returns_correct_merged_boxes(self):
        ...
        self.assertAllClose(
            transformed_inputs[fields.InputDataFields.groundtruth_classes], [[1, 0, 1]]
        )
        self.assertAllClose(
            transformed_inputs[fields.InputDataFields.groundtruth_confidences],
            [[1, 0, 1]],
        ...
        self.assertAllClose(
            transformed_inputs[fields.InputDataFields.num_groundtruth_boxes], 1
        )
    ...
    def test_returns_resized_masks(self):
        ...
        self.assertAllEqual(
            transformed_inputs[fields.InputDataFields.original_image].dtype, tf.uint8
        )
        self.assertAllEqual(
        ...
        self.assertAllEqual(
            transformed_inputs[fields.InputDataFields.original_image].shape, [8, 8, 3]
        )
        self.assertAllEqual(
            transformed_inputs[fields.InputDataFields.groundtruth_instance_masks].shape,
            [2, 8, 8],
        )
    ...
    def test_applies_model_preprocess_fn_to_image_tensor(self):
        ...
        tensor_dict = {
            fields.InputDataFields.image: tf.constant(np_image),
            fields.InputDataFields.groundtruth_classes: tf.constant(
                np.array([3, 1], np.int32)
            ),
        }
        ...
        self.assertAllClose(
            transformed_inputs[fields.InputDataFields.image], np_image / 255.0
        )
        self.assertAllClose(
            transformed_inputs[fields.InputDataFields.true_image_shape], [4, 4, 3]
        )
    ...
    def test_applies_data_augmentation_fn_to_tensor_dict(self):
        ...
        self.assertAllEqual(
            augmented_tensor_dict[fields.InputDataFields.image], np_image + 1
        )
        self.assertAllEqual(
    ...
    def test_applies_data_augmentation_fn_before_model_preprocess_fn(self):
        ...
        self.assertAllEqual(
            augmented_tensor_dict[fields.InputDataFields.image], (np_image + 5) * 2
        )
...
class PadInputDataToStaticShapesFnTest(test_case.TestCase):
    def test_pad_images_boxes_and_classes(self):
        input_tensor_dict = {
            fields.InputDataFields.image: tf.placeholder(tf.float32, [None, None, 3]),
            fields.InputDataFields.groundtruth_boxes: tf.placeholder(
                tf.float32, [None, 4]
            ),
            fields.InputDataFields.groundtruth_classes: tf.placeholder(
                tf.int32, [None, 3]
            ),
            fields.InputDataFields.true_image_shape: tf.placeholder(tf.int32, [3]),
            fields.InputDataFields.original_image_spatial_shape: tf.placeholder(
                tf.int32, [2]
            ),
        }
    ...
    def test_clip_boxes_and_classes(self):
        input_tensor_dict = {
            ...
            fields.InputDataFields.num_groundtruth_boxes: tf.placeholder(tf.int32, []),
        }
        padded_tensor_dict = inputs.pad_input_data_to_static_shapes(
            tensor_dict=input_tensor_dict,
            max_num_boxes=3,
        ...
        with self.test_session() as sess:
            out_tensor_dict = sess.run(
                ...
                feed_dict={
                    ...
                    input_tensor_dict[fields.InputDataFields.num_groundtruth_boxes]: 5,
                },
            )
        ...
        self.assertAllEqual(
            out_tensor_dict[fields.InputDataFields.groundtruth_classes].shape, [3, 3]
        )
        self.assertEqual(
    ...
    def test_images_and_additional_channels(self):
        input_tensor_dict = {
            fields.InputDataFields.image: tf.placeholder(tf.float32, [None, None, 3]),
            fields.InputDataFields.image_additional_channels: tf.placeholder(
    ...
    def test_gray_images(self):
        input_tensor_dict = {
            fields.InputDataFields.image: tf.placeholder(tf.float32, [None, None, 1]),
        }
        padded_tensor_dict = inputs.pad_input_data_to_static_shapes(
            tensor_dict=input_tensor_dict,
            max_num_boxes=3,
    ...
    def test_keypoints(self):
        input_tensor_dict = {
            fields.InputDataFields.groundtruth_keypoints: tf.placeholder(
                tf.float32, [None, 16, 4]
            ),
            fields.InputDataFields.groundtruth_keypoint_visibilities: tf.placeholder(
                tf.bool, [None, 16]
            ),
        }
        padded_tensor_dict = inputs.pad_input_data_to_static_shapes(
