...
class TargetAssigner(object):
    ...
    def __init__(self, similarity_calc, matcher, box_coder, negative_class_weight=1.0):
...
def create_target_assigner(
    ...
    return TargetAssigner(
        similarity_calc, matcher, box_coder, negative_class_weight=negative_class_weight
    )
...
def batch_assign_confidences(
    ...
    for anchors, gt_boxes, gt_class_confidences, gt_weights in zip(
        ...
        cls_targets_without_background = cls_targets_without_background * (
            1 - tf.to_float(negative_mask)
        )
        cls_weights_without_background = (1 - implicit_class_weight) * tf.to_float(
            explicit_example_mask
