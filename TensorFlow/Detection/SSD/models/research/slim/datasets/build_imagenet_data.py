...
tf.app.flags.DEFINE_integer(
    "train_shards", 1024, "Number of shards in training TFRecord files."
)
tf.app.flags.DEFINE_integer(
    "validation_shards", 128, "Number of shards in validation TFRecord files."
)

tf.app.flags.DEFINE_integer(
    "num_threads", 8, "Number of threads to preprocess the images."
)
...
# with an image file.
tf.app.flags.DEFINE_string(
    "bounding_box_file", "./imagenet_2012_bounding_boxes.csv", "Bounding box file"
)
