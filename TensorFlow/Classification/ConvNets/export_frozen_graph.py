...
tf.app.flags.DEFINE_string(
    "model_name",
    "resnet50",
    "The name of the architecture to save. The default name was being "
...
tf.app.flags.DEFINE_integer("num_classes", 1001, "The number of classes to predict.")
...
tf.app.flags.DEFINE_string(
    "input_format", "NCHW", "The dataformat used by the layers in the model"
)

tf.app.flags.DEFINE_string(
    "compute_format", "NCHW", "The dataformat used by the layers in the model"
)

tf.app.flags.DEFINE_string("checkpoint", "", "The trained model checkpoint.")
...
tf.app.flags.DEFINE_bool("symmetric", False, "Using symmetric quantization or not.")
...
tf.app.flags.DEFINE_bool(
    "write_text_graphdef", False, "Whether to write a text version of graphdef."
)
