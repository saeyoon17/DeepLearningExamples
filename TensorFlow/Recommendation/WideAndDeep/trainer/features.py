...
DOC_CATEGORICAL_MULTIVALUED_COLUMNS = {
    ...
    "doc_ad_topic_id": ["doc_ad_topic_id_1", "doc_ad_topic_id_2", "doc_ad_topic_id_3"],
    "doc_ad_entity_id": [
        "doc_ad_entity_id_1",
        "doc_ad_entity_id_2",
        "doc_ad_entity_id_3",
...
BOOL_COLUMNS = ["event_weekend", "user_has_already_viewed_doc"]
...
ITEM_MULTI_HOT_COLUMNS = ["doc_ad_topic_id", "doc_ad_entity_id", "doc_ad_category_id"]
    ...
    for column_name in training_columns:
        if column_name in HASH_BUCKET_SIZES:
            ...
            if column_name in FLOAT_COLUMNS_SIMPLE_BIN_TRANSFORM:
                ...
                columns.append(
                    tf.feature_column.numeric_column(column_name, shape=(1,))
                )
