...
clicks_train_joined_df = clicks_train_df.join(
    promoted_content_df, on="ad_id", how="left"
).join(events_df, on="display_id", how="left")
clicks_train_joined_df.createOrReplaceTempView("clicks_train_joined")

validation_display_ids_df = (
    clicks_train_joined_df.select("display_id", "day_event")
    .distinct()
    .sampleBy(
        "day_event",
        fractions={
...
validation_set_df = spark.sql(
    """SELECT display_id, ad_id, uuid_event, day_event,
...
validation_set_df.write.parquet(
    OUTPUT_BUCKET_FOLDER + validation_set_gcs_output, mode="overwrite"
)
