...
def evaluate(iterable, options=None):
    ...
    for i, line in enumerate(iterable):
        ...
        if num_features is None:
            ...
            raise FormatError(
                "unexpected number of features: %d (%d) at line %d\n%s"
...
def report(counts, out=None):
    ...
    c = counts
    out.write(
        "processed %d tokens with %d phrases; " % (c.token_counter, c.found_correct)
    )
...
if __name__ == "__main__":
    ...
    return_report(
        "/home/pengy6/data/sentence_similarity/data/cdr/test1/wanli_result2/label_test.txt"
    )
