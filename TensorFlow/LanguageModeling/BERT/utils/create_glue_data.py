...
def convert_single_example(
    ex_index, example, label_list, max_seq_length, tokenizer, verbose_logging=False
):
...
def main():
    ...
    train_file = os.path.join(
        FLAGS.data_dir, "final_tfrecords_sharded/" + task_name + "train.tf_record"
    )
    ...
    eval_file = os.path.join(
        FLAGS.data_dir, "final_tfrecords_sharded/" + task_name + "eval.tf_record"
    )
    file_based_convert_examples_to_features(
    ...
    predict_file = os.path.join(
        FLAGS.data_dir, "final_tfrecords_sharded/" + task_name + "predict.tf_record"
    )
    file_based_convert_examples_to_features(
