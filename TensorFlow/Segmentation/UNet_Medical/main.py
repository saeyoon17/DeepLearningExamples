...
from utils.setup import (build_estimator, get_logger, prepare_model_dir,
                         set_flags)
...
def main(_):
    ...
    if "train" in params.exec_mode:
        ...
        hooks = [
            ...
            TrainingHook(logger, max_steps=max_steps, log_every=params.log_every),
        ]
            ...
            if not params.benchmark:
                multipage_tif = [
                    Image.fromarray(mask).resize(
                        size=(512, 512), resample=Image.BILINEAR
                    )
