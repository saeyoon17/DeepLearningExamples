...
from dlexport.tensorflow import to_onnx, to_savedmodel, to_tensorrt
...
PARSER.add_argument(
    "--to", dest="to", choices=["savedmodel", "tensorrt", "onnx"], required=True
)
...
PARSER.add_argument(
    "--data_dir", type=str, help="""Directory where to download the dataset"""
)

PARSER.add_argument(
    "--checkpoint_dir", type=str, help="""Directory where to download the dataset"""
)

PARSER.add_argument(
    "--savedmodel_dir", type=str, help="""Directory where to download the dataset"""
)
