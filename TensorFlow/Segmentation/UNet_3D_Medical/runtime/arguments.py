...
PARSER.add_argument(
    "--loss", choices=["dice", "ce", "dice+ce"], default="dice+ce", type=str
)
PARSER.add_argument("--warmup_steps", default=40, type=int)
PARSER.add_argument(
    "--normalization",
    choices=["instancenorm", "batchnorm", "groupnorm"],
...
PARSER.add_argument(
    "--resume_training", dest="resume_training", action="store_true", default=False
)
