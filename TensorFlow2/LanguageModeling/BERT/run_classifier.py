...
flags.DEFINE_string(
    "train_data_path", None, "Path to training data for BERT classifier."
)
flags.DEFINE_string(
    "eval_data_path", None, "Path to evaluation data for BERT classifier."
)
...
def run_bert_classifier(
    ...
    if use_keras_compile_fit:
        ...
        logging.info(
            "Training using TF 2.0 Keras compile/fit API with " "distribution strategy."
        )
    ...
    logging.info(
        "Training using customized training loop TF 2.0 with " "distribution strategy."
    )
