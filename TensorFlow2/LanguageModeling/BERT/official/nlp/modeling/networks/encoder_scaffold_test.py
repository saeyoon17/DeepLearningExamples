...
class EncoderScaffoldLayerClassTest(keras_parameterized.TestCase):
    ...
    def test_serialize_deserialize(self):
        ...
        new_network = encoder_scaffold.EncoderScaffold.from_config(network.get_config())
...
class EncoderScaffoldEmbeddingNetworkTest(keras_parameterized.TestCase):
    def test_network_invocation(self):
        ...
        self.assertIs(embedding_layer.embeddings, test_network.get_embedding_table())
...
class EncoderScaffoldHiddenInstanceTest(keras_parameterized.TestCase):
    ...
    def test_serialize_deserialize(self):
        ...
        new_data, new_cls = new_model.predict([word_id_data, mask_data, type_id_data])
