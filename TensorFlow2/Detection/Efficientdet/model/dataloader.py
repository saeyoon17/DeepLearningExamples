...
from object_detection import preprocessor, tf_example_decoder
...
class InputProcessor:
    ...
    def resize_and_crop_image(self, method=tf.image.ResizeMethod.BILINEAR):
        ...
        self._image = tf.image.pad_to_bounding_box(
...
class InputReader:
    ...
    def dataset_parser(self, value, example_decoder, anchor_labeler, params):
        ...
        with tf.name_scope("parser"):
            ...
            input_processor.normalize_image(
                dtype=tf.float16 if params["mixed_precision"] else tf.float32
            )
    ...
    def dataset_options(self):
        ...
        options.experimental_optimization.map_parallelization = (
            self._enable_map_parallelization
        )
