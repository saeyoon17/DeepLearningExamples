...
RESNET_URL = (
    "https://api.ngc.nvidia.com/v2/models/nvidia/rn50_tf_amp_ckpt/versions/20.06.0/zip"
)
...
if __name__ == "__main__":
    ...
    print(
        f"Downloading and extracting {RESNET_NAME} checkpoint from {params.download_url}"
    )
