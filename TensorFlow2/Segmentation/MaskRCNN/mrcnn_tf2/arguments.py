...
HYPER_GROUP.add_argument(
    "--finetune_bn", action="store_true", help="Is batchnorm finetuned training mode"
)
...
HYPER_GROUP.add_argument("--xla", action="store_true", help="Enable XLA JIT Compiler")
...
LOGGING_GROUP.add_argument(
    "--log_graph", action="store_true", help="Print details about TF graph"
)
...
UTILITY_GROUP.add_argument(
    "-v", "--verbose", action="store_true", help="Displays debugging logs"
)
