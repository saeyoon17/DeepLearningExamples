...
from mrcnn_tf2.model.losses import FastRCNNLoss, MaskRCNNLoss, RPNLoss
from mrcnn_tf2.model.models.fpn import FPNNetwork
from mrcnn_tf2.model.models.heads import BoxHead, MaskHead, RPNHead
from mrcnn_tf2.model.models.resnet50 import ResNet50
from mrcnn_tf2.ops import (postprocess_ops, roi_ops, spatial_transform_ops,
                           training_ops)
...
class MaskRCNN(tf.keras.Model):
    def __init__(self, params, name="mrcnn", trainable=True, *args, **kwargs):
        ...
        self.fast_rcnn_loss = FastRCNNLoss(num_classes=self._params.num_classes)
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        batch_size, image_height, image_width, _ = (
            inputs["images"].get_shape().as_list()
        )
        ...
        all_anchors = anchors.Anchors(
            ...
            self._params.num_scales,
            self._params.aspect_ratios,
        ...
        def rpn_head_fn(features, min_level=2, max_level=6):
            ...
            for level in range(min_level, max_level + 1):
                scores_outputs[level], box_outputs[level] = self.rpn_head(
                    features[level], training=training
                )
        ...
        box_roi_features = spatial_transform_ops.multilevel_crop_and_resize(
            features=fpn_feats, boxes=rpn_box_rois, output_size=7, training=training
        )
        ...
        if not training:
            ...
            (
                ...
                max_num_fg=int(
                    self._params.batch_size_per_im * self._params.fg_fraction
                ),
            )
        ...
        mask_outputs = self.mask_head(
            inputs=(mask_roi_features, class_indices), training=training
        )
