...
PARSER.add_argument(
    "--log_dir", type=str, default=None, help="""Output directory for training logs"""
)

PARSER.add_argument(
    "--batch_size", type=int, default=1, help="""Size of each minibatch per GPU"""
)
...
PARSER.add_argument(
    "--weight_decay", type=float, default=0.0005, help="""Weight decay coefficient"""
)

PARSER.add_argument(
    "--log_every", type=int, default=100, help="""Log performance every n steps"""
)

PARSER.add_argument(
    "--evaluate_every", type=int, default=0, help="""Log performance every n steps"""
)
...
PARSER.add_argument(
    "--use_tftrt", dest="use_tftrt", action="store_true", help="""Use TF-TRT"""
)
