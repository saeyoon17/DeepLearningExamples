...
def main():
    ...
    for mapping_name, mapping in fspec_in.source_spec.items():
        for chunk in mapping:
            ...
            assert (
                len(chunk["files"]) == 1
            ), "Only one file per chunk supported in this generator"
